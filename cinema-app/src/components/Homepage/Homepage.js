     ...
     <Carousel>
        ...
        <Stack direction="horizontal" className="h-100 justify-content-center align-items-center" gap={3}>
            ...
            <Card.Body>
                ...
                <a href="https://www.youtube.com/watch?v=mqqft2x_Aa4" target="_blank"><Button variant="secondary">Watch trailer</Button></a>
                </div>
            ...
            <Card.Body>
                ...
                <div class = "showtimes">
                <Link to  = "/selectShowtime"><Button variant="btn btn-dark"> Book now</Button></Link>
                <a href="https://www.youtube.com/watch?v=wxN1T1uxQ2g" target="_blank"><Button variant="secondary">Watch trailer</Button></a>
                </div>
            </Card.Body>
            </Card>
            ...
            <Card.Body>
                ...
                <div class = "showtimes">
                <Link to  = "/selectShowtime"><Button variant="btn btn-dark"> Book now</Button></Link>
                <a href="https://www.youtube.com/watch?v=zSWdZVtXT7E" target="_blank"><Button variant="secondary">Watch trailer</Button></a>
                </div>
            </Card.Body>
            </Card>
     ...
     <Carousel.Item  width = {500} height = {5}>
        <Stack direction="horizontal" className="h-100 justify-content-center align-items-center" gap={3}>
            ...
            <Card.Body>
                ...
                <div class = "showtimes">
                <Link to  = "/selectShowtime"><Button variant="btn btn-dark"> Book now</Button></Link>
                <a href="https://www.youtube.com/watch?v=5xH0HfJHsaY" target="_blank"><Button variant="secondary">Watch trailer</Button></a>
                </div>
            </Card.Body>
            </Card>
            <Card style={{ width: '25rem' }}>
            ...
            <Card.Body>
                ...
                <div class = "showtimes">
                <Link to  = "/selectShowtime"><Button variant="btn btn-dark"> Book now</Button></Link>
                <a href="https://www.youtube.com/watch?v=4eaZ_48ZYog" target="_blank"><Button variant="secondary">Watch trailer</Button></a>
                </div>
            ...
            <Card.Body>
                ...
                <div class = "showtimes">
                <Link to  = "/selectShowtime"><Button variant="btn btn-dark"> Book now</Button></Link>
                <a href="https://www.youtube.com/watch?v=s7EdQ4FqbhY" target="_blank"><Button variant="secondary">Watch trailer</Button></a>
                </div>
     ...
     <Carousel>
        ...
        <Stack direction="horizontal" className="h-100 justify-content-center align-items-center" gap={3}>
            ...
            <Card.Body>
                ...
                <div class = "showtimes">
                <Link to  = "/selectShowtime"><Button variant="btn btn-dark"> Book now</Button></Link>
                <a href="https://www.youtube.com/watch?v=bK6ldnjE3Y0" target="_blank"><Button variant="secondary">Watch trailer</Button></a>
                </div>
            ...
            <Card.Body>
                ...
                <div class = "showtimes">
                <Link to  = "/selectShowtime"><Button variant="btn btn-dark"> Book now</Button></Link>
                <a href="https://www.youtube.com/watch?v=hebWYacbdvc" target="_blank"><Button variant="secondary">Watch trailer</Button></a>
                </div>
            ...
            <Card.Body>
                ...
                <div class = "showtimes">
                <Link to  = "/selectShowtime"><Button variant="btn btn-dark"> Book now</Button></Link>
                <a href="https://www.youtube.com/watch?v=JqcncLPi9zw" target="_blank"><Button variant="secondary">Watch trailer</Button></a>
                </div>
        ...
        <Stack direction="horizontal" className="h-100 justify-content-center align-items-center" gap={3}>
            ...
            <Card.Body>
                ...
                <div class = "showtimes">
                <Link to  = "/selectShowtime"><Button variant="btn btn-dark"> Book now</Button></Link>
                <a href="https://www.youtube.com/watch?v=9-dIdFXeFhs" target="_blank"><Button variant="secondary">Watch trailer</Button></a>
                </div>
            ...
            <Card.Body>
                ...
                <div class = "showtimes">
                <Link to  = "/selectShowtime"><Button variant="btn btn-dark"> Book now</Button></Link>
                <a href="https://www.youtube.com/watch?v=8zIf0XvoL9Y" target="_blank"><Button variant="secondary">Watch trailer</Button></a>
                </div>
            ...
            <Card.Body>
                ...
                <div class = "showtimes">
                <Link to  = "/selectShowtime"><Button variant="btn btn-dark"> Book now</Button></Link>
                <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank"><Button variant="secondary">Watch trailer</Button></a>
                </div>
